...
module SocialChallenges
	...
	class ResizeImage
		...
		attr_reader :fname, :maxWidthImage, :maxHeightImage, :maxWidthThumb, :maxHeightThumb, :resizeQuality

		def initialize(fname, maxWidthImage, maxHeightImage, maxWidthThumb, maxHeightThumb, resizeQuality)
			@fname= fname
		...
		def self.resize(fname, maxWidthImage, maxHeightImage, maxWidthThumb, maxHeightThumb, resizeQuality)
