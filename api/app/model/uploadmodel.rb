...
class Uploadmodel
  ...
  def to_json(*a)
    ...
    {"id" => @id, "type" => @type, "file_name" => @file_name, "original_file_name" => @original_file_name, "file_name" => "http://localhost:9292/upload/#{@id}/download", 
    "file_name_thumb" => "http://localhost:9292/upload/#{@id}/download/thumb", "file_name_medium" => "http://localhost:9292/upload/#{@id}/download/medium", "userid" => @userid, 
