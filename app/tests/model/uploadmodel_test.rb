...
describe Uploadmodel do
  ...
  describe "deserializing" do
    it "must deserialize to json" do
      upload.to_json.must_equal '{"id":null,"type":"image/jpeg","file_name":"http://localhost:9292/upload//download","userid":1,"upload_datetime":"'+time_now+'","overallScore":0,"numOfRatings":0,"title":"The title","description":"The description","tags":["tag1","tag2","tag3"]}'
    end
  end
